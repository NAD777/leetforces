...
class TestRunner:
    ...
    def __init__(self, task_id, submission_ext):
        ...
        try:
            ...
            print(e)
            raise ValueError("Exception has occured while trying to retrieve the task configurations")
    ...
    def run(self, submission_id, filename, source_file)-> Dict[int, Tuple[str, str]]:
        ...
        try:
            ...
            report = node.run_tests(submission_id, self.task_id, self.test_details)  
